...
with open("code holder.json") as file:
    data = json.load(file)
...
def recreatedChat():
        ...
        while True:
            ...
            if ref1 != ref2:
                ...
                # Code for typing in notepad
                createdCode = open('Program.txt','a')
                createdCode.write(upload_response)
                createdCode.close()
                ...
                # ref_cont = db.reference('Countinue')
                # ref_cont.update({
                #     'state': '1'
                # })
